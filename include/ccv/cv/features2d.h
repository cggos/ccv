#ifndef CCV_CV_Features2D_H
#define CCV_CV_Features2D_H
...
class Features2D {
 ...
 public:
  ...
  static int zero_mean_sum_of_squared_distance(Image<unsigned char> &img1,
...
_F Features2D::sum_of_squared_distance(Image<_T> &img1, Image<_T> &img2) {
  ...
  if (img1.empty() || img2.empty()) return max_ssd + 1;

  cg::Size size1 = img1.size();
  cg::Size size2 = img2.size();
  if (size1 != size2) return max_ssd + 1;
